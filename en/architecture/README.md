...
In the Database Per Service model, each service in a distributed application has a separate database.  This is in contrast with a monolith database where one or many services talk to a single database.  
